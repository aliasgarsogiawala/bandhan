...
export const destinationsResource: ResourceConfig<Destination> = {
  ...
  visibleFields: ["name", "price", "tag", "image", "description", "status"],
  columns: [
    { key: "image", label: "", render: (d) => <Thumb src={d.image} alt={d.name} /> },
    { key: "name", label: "Name", className: "font-semibold text-primary" },
    { key: "status", label: "Status", render: (d) => badge(d.status === "draft" ? "Draft" : "Active", d.status === "draft" ? "bg-slate-100 text-slate-600 border-slate-200" : "bg-emerald-50 text-emerald-600 border-emerald-200") },
  ...
  fields: [
    ...
    { name: "startingPoint", label: "Starting Point", type: "text", placeholder: "e.g. Srinagar Airport" },
    { name: "groupSize", label: "Group Size", type: "text", placeholder: "e.g. 2 – 16 guests" },
    ...
    { name: "faqs", label: "Frequently asked questions", type: "faqs", fullWidth: true },
