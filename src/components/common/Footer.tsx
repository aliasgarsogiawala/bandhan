        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="font-sans text-sm [&_a]:inline-flex [&_a]:min-h-10 [&_a]:items-center">
              ...
              <li>
                <Link href="/mice" className="hover:text-gold transition-colors duration-300">Corporate &amp; MICE</Link>
              </li>
              <li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 font-sans text-sm text-slate-400">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>226, Lodha Supremus Tower 2, Road No. 22, Wagle Industrial Estate, Thane West – 400604</span>
              </li>
            </ul>
          </div>
